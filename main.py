...
def stockfish():
    engine = chess.engine.SimpleEngine.popen_uci(
        "C:/Users/Paul/Desktop/Records/stockfish_14.1_win_x64_avx2/stockfish_14.1_win_x64_avx2.exe")
...
def lines():
    speak(
        "Hello! Welcome to the chess! Have fun!.")
...
def main():
    ...
    ret += '<form action="/engine/" method="post"><button name="Computer Move" type="submit">Make Computer Move</button></form>'
